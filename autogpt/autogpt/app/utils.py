...
def vcs_state_diverges_from_default_branch() -> bool:
    import git

    repo = git.Repo()
    current_branch = repo.active_branch
    og_remote = repo.remotes.origin

    # Determine the default branch name (e.g., 'main' or 'master')
    default_branch_name = og_remote.refs[0].remote_head

    default_branch = og_remote.refs[default_branch_name]
    return current_branch.commit != default_branch.commit
